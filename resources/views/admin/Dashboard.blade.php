...
<body>
    ...
    <aside id="default-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <div class=" ms-7">
                <h1 class="text-gray-50 mx-auto text-2xl italic mt-5 ">Stryve Solutions</h1>
            </div>
    ...
    <div class="p-4 sm:ml-64 bg-gray-700 h-screen">
        <div class="p-4  mt-10">
            ...
            <div class="relative overflow-x-auto ">
                ...
                <a href="/test"
                    class=" float-end focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">
                    Send Welcome Message To Whatssap </a>
